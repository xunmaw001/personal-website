	...
	<body>
		...
		<div id="app">
			...
			<div class="data-container layui-row">
				...
				<div class="line-container">
					<p class="line"> 学生博客展示 </p>
				</div>
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../xueshengboke/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../xueshengboke/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in xueshengbokeList" v-bind:key="index" v-if="item">
																																										
						<img class="cover" :src="item.fengmiantupian?item.fengmiantupian.split(',')[0]:''">
						
																																																																																																												
																		
						<h3 class="title">{{item.wenzhangbiaoti}}</h3>
				...
				http.request('news/list', 'get', {
					...
					if (newsList.length > 2 && newsList.length <= 8) {
						...
						console.log('rightNewsList',rightNewsList,vue.rightNewsList)
                                                                                ...
                                                                                http.request(`xueshengboke/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.xueshengbokeList = res.data.list
				});
