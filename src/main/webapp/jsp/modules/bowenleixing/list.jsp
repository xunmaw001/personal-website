...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">博文类型管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>博文类型管理</span></li>
								<li class="breadcrumb-item active"><span>博文类型列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">博文类型列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										博文类型
									</label>
									<input type="text" id="bowenleixingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										标题
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('bowenleixing')">博文类型<i id="bowenleixingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#bowenleixingSearch').val() != null && $('#bowenleixingSearch').val() != ''){
				searchForm.bowenleixing ="%" +  $('#bowenleixingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("bowenleixing/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				bowenleixing : searchForm.bowenleixing,	
		...
		function setDataRow(item,number){
			...
			var bowenleixingCell  = document.createElement('td');

						 bowenleixingCell.innerHTML = item.bowenleixing;


			row.appendChild(bowenleixingCell);
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("bowenleixing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"bowenleixing");
