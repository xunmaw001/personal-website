		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑学生博客</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>学生博客管理</span></li>
								<li class="breadcrumb-item active"><span>编辑学生博客</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">学生博客信息</h3>
	...
	<script>
		...
		var fenleiOptions = [];
				...
				function fenleiSelect(){
					http("option/bowenleixing/bowenleixing","GET",{},(res)=>{
						if(res.code == 0){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "xueshengboke/info/" + id,
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("xueshengboke/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("xueshengboke/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("xueshengboke"+colName,"GET",{
				tableName: "xueshengboke",
				columnName: colName
			},(res)=>{
				if(res.code == 0){
